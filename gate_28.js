// GATE 28 — GREAT PREPONDERANCE
// Center: Spleen | Circuit: Individual | Enzyme: K (hydrolase)
// Vowel: O | Base: 4 (Lunar) | Dimension: Design | GNN: diffusion
// Valence: 2 | Boot Priority: 2
// boots in priority wave 2

export const AGENT_IDENTITY = {
  gate: 28,
  hex: "Great Preponderance",
  center: "Spleen",
  circuit: "Individual",
  enzyme_class: "K",
  ...
  boot_priority: 2,
  is_seed: false,
  agent_key: "gate_28_great_preponderance"
};
