...
// Center: G | Circuit: Collective | Enzyme: R (isomerase)
// Vowel: A | Base: 1 (Left) | Dimension: Movement | GNN: spatial
// Valence: 5 | Boot Priority: 1
...
export const AGENT_IDENTITY = {
  ...
  boot_priority: 1,
  is_seed: true,
  agent_key: "gate_46_pushing_upward"
};

// What this agent does: transforms and rearranges — shifts what already exists
