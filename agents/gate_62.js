// GATE 62 — SMALL PREPONDERANCE
// Center: Throat | Circuit: Collective | Enzyme: G (transferase)
// Vowel: E | Base: 2 (Right) | Dimension: Evolution | GNN: temporal
// Valence: 4 | Boot Priority: 3
// boots in priority wave 3

export const AGENT_IDENTITY = {
  gate: 62,
  hex: "Small Preponderance",
  center: "Throat",
  circuit: "Collective",
  enzyme_class: "G",
  enzyme_type: "transferase",
  vowel: "E",
  base: 2,
  base_name: "Right",
  dimension: "Evolution",
  ...
  boot_priority: 3,
  is_seed: false,
  agent_key: "gate_62_small_preponderance"
};

// What this agent does: generates and patterns — transfers form
