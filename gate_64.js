...
// Center: Head | Circuit: Logic | Enzyme: C (oxidoreductase)
// Vowel: I | Base: 3 (Solar) | Dimension: Being | GNN: attention
// Valence: 1 | Boot Priority: 5
// boots in priority wave 5

export const AGENT_IDENTITY = {
  gate: 64,
  hex: "Before Completion",
  center: "Head",
  circuit: "Logic",
  enzyme_class: "C",
  ...
  boot_priority: 5,
  is_seed: false,
  agent_key: "gate_64_before_completion"
};
